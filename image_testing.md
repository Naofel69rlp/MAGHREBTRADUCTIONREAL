...
## Feature under test: OCR + Translate (POST /api/ocr-translate)
- Endpoint accepts JSON: { image_base64: <base64 jpeg/png>, target_lang: <code>, source_lang: "auto"|<code> }
- Auth required (Bearer session token).
- Returns: { detected_text, detected_lang, translation, phonetic, usage }
- Must NOT store the image. Must NOT auto-add to history.
- Counts as 1 translation against the free daily limit (3/day) unless premium.
